...
let ProductController = class ProductController {
    ...
    async create(body) {
        return this.productService.create(Object.assign({}, body));
    }
    async update(id, body) {
        await this.productService.update(id, Object.assign({}, body));
        return this.productService.findOne({ id });
    }
    async delete(id) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, product_create_dto_1.ProductUpdateDto]),
    __metadata("design:returntype", Promise)
